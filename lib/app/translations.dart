...
class Translations {
  ...
  static const List<String> _dictionary = [
    'appName:Film ve Dizi Listem:Film & Series List:Mi Lista de Películas y Series:Ma liste de films et séries:Minha Lista de Filmes e Séries:Meine Film- und Serienliste',
    ...
    'saved:Kaydedildi:Saved:Guardado:Enregistré:Salvo:Gespeichert',
    'errorPrefix:Hata:Error:Error:Erreur:Erro:Fehler',
    ...
    'commentHint:Yorum yazın...:Write a comment...:Escribe un comentario...:Écrivez un commentaire...:Escreva um comentário...:Kommentar schreiben...',
    ...
    'discoveryTopTitle:IMDb En İyileri:IMDb Best:Lo mejor de IMDb:Meilleurs IMDb:Melhores do IMDb:IMDb Beste',
    'discoveryTopSubtitle:En iyi film ve diziler OMDb API üzerinden parça parça yüklenir.:Top movies and series load in batches from the OMDb API.:Las mejores películas y series se cargan por partes desde OMDb API.:Les meilleurs films et séries se chargent par lots depuis l API OMDb.:Os melhores filmes e séries carregam em lotes pela API OMDb.:Top-Filme und Serien werden stapelweise aus der OMDb API geladen.',
    'discoveryAll:Tümü:All:Todo:Tout:Todos:Alle',
    'discoveryMovies:Filmler:Movies:Películas:Films:Filmes:Filme',
    'discoverySeries:Diziler:Series:Series:Séries:Séries:Serien',
    'discoveryEmpty:Keşfet içeriği yüklenemedi.:Discovery content could not be loaded.:No se pudo cargar el contenido.:Le contenu de découverte n a pas pu être chargé.:Não foi possível carregar o conteúdo.:Discovery-Inhalte konnten nicht geladen werden.',
